...
def parse_args():
    ...
    parser.add_argument('--srcpath', default='/raid/detection/dota')
    parser.add_argument('--dstpath', default=r'/raid/detection/AerialDetection/dota1-split-1024',
                        help='prepare data')
...
def prepare(srcpath, dstpath):
    ...
    split_test = SplitOnlyImage_multi_process.splitbase(os.path.join(srcpath, 'val', 'images'),
    ...
    DOTA2COCOTrain(os.path.join(dstpath, 'trainval1024'),
                   os.path.join(dstpath, 'trainval1024', 'DOTA_trainval1024.json'), wordname_15, difficult='-1')
    DOTA2COCOTest(os.path.join(dstpath, 'test1024'), os.path.join(dstpath, 'test1024', 'DOTA_test1024.json'),
                  wordname_15)
