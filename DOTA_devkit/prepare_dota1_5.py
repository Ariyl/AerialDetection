...
def parse_args():
    ...
    parser.add_argument('--dstpath', default=r'/raid/detection/AerialDetection/dota1_5-split-1024',
                        help='prepare data')
...
def prepare(srcpath, dstpath):
    ...
    DOTA2COCOTrain(os.path.join(dstpath, 'trainval1024'), os.path.join(dstpath, 'trainval1024', 'DOTA1_5_trainval1024.json'), wordname_16, difficult='-1')
